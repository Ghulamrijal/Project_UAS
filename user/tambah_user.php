                                    ...
                                    <div class="card-body card-block">
                                        <form action="query_tambah.php" method="post" class="form-horizontal" >
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-5">
                                                <select name="idpegawai" class="col col-sm-6">
                                                        <?php 
                                                        include '../koneksi.php';
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="username"  class="form-control" >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                    ...
                                                    <div class="col col-sm-6">
                                                        <input type="text" id="input-normal" name="password" class="form-control" >
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="radio" id="input-normal" name="role" value="ADMIN">ADMIN
                                                    <input type="radio" id="input-normal" name="role" value="USER">USER
                                                </div>
                                            </div>
