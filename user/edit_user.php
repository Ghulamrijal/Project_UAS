                                         ...
                                         <form action="query_edit.php" method="post" class="form-horizontal" >
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                    <label for="input-normal" class=" form-control-label">USERNAME</label>
                                                    <input type="hidden" name="iduser" value="<?php echo $data['iduser']; ?>">
                                                </div>
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="username"  class="form-control" value="<?php echo $data['username']; ?>" >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                    ...
                                                    <div class="col col-sm-6">
                                                        <input type="text" id="input-normal" name="password" class="form-control" value="<?php echo $data['password']; ?>" >
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="radio" id="input-normal" name="role" value="<?php echo $data['role']; ?>">ADMIN
                                                    <input type="radio" id="input-normal" name="role" value="<?php echo $data['role']; ?>">USER
                                                </div>
                                            </div>
