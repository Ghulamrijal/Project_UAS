                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">DISKOMINFO</a>
                                        </div>
                                        ...
                                        <form action="query_edit.php" method="post" class="form-horizontal" >
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="nama" placeholder="Normal" class="form-control" value="<?php echo $data['nama']; ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="alamat" placeholder="Normal" class="form-control" value="<?php echo $data['alamat']; ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                    ...
                                                    <div class="col col-sm-6">
                                                        <input type="text" id="input-normal" name="jabatan" placeholder="Normal" class="form-control"  value="<?php echo $data['jabatan']; ?>">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="email" placeholder="Normal" class="form-control"  value="<?php echo $data['email']; ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="umur" placeholder="Normal" class="form-control"  value="<?php echo $data['umur']; ?>">
                                                </div>
                                            </div>
